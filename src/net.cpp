...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Achieverpoint " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    // {"achieverpointtools.com", "dnsseed.achieverpointtools.com"},
    // {"achieverpointpool.org", "dnsseed.achieverpointpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    // {"achieverpointtools.com", "testnet-seed.achieverpointtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Achieverpoint is probably already running."), addrBind.ToString().c_str());
        else
